...
const Skills = () => {
  const Skills = [
    ...
    { name: "Express", icon: <SiExpress />, familiarity: 3 },
    { name: "Node", icon: <FaNodeJs />, familiarity: 3 },
  ];
  return (
    <div className="mt-7">
      ...
      <p className="ml-2">
        ...
        <NavLink
          className="text-iOrange inline-block font-semibold hover:bg-iOrange hover:text-white"
          to="/tech-stack"
        >
          click here.
        </NavLink>
